<template>
  <svg id="questionMark" width="660" height="660" viewBox="0 0 820 820" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g>
      ...
      <defs>
        <path id="textGeneratePath" d="M17 410a393 393 0 1 0 786 0a393 393 0 1 0 -786 0" />
      </defs>
      <use xlink:href="#textGeneratePath" fill="none"/>
      <text fill="#000">
          <textPath alignment-baseline="top" xlink:href="#textGeneratePath">
            Click to generate Mood Mosaic Images &nbsp; &#x2022; &nbsp; Click to generate Mood Mosaic Images &nbsp; &#x2022; &nbsp;
          </textPath>
      </text>
